(function() {
    ...
    Ext.onReady(function() {
        ...
        function setParam(param) {
        	//console.dir(param);
        	//alert("最好是存放到cookie中，然后刷新整个页面");
        	//Ext.util.CSS.swapStyleSheet("theme", "ext-4/resources/css/ext-all-neptune.css");
...
//                            }
            ...
            toolbar.alignTo(
                ...
                [
                    ...
                    -(document.body.scrollTop || document.documentElement.scrollTop)+28
                ]
            );
