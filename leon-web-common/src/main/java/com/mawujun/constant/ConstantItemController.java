...
public class ConstantItemController {
	...
	public List<ConstantItem> query(String constan_id){	
		...
		return constantItemService.query(Cnd.select().andEquals(M.ConstantItem.constant.id, constan_id));
	}
	...
	public List<ConstantItem> queryByCode(String code){	
		...
		List<ConstantItem> list=constantItemService.query(Cnd.select().andEquals(M.ConstantItem.constant.code, code));
