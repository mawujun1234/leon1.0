...
INSERT INTO leon_parameter(ID, CONTENT, description, NAME, SHOWMODEL, SORT, SUBJECTS, VALIDATION, VALUEENUM) VALUES
('menuId', 'com.mawujun.parameter.MenuDataSource', '配置使用哪个菜单', '菜单', 'COMBOBOX', 0, '["USER","POSITION","UNIT","GROUP","ROLE","SYSTEM"]', NULL, 'JAVA');
INSERT INTO leon_parameter_subject(PARAMETER_ID, SUBJECT_ID, SUBJECTTYPE, PARAMETERVALUE) VALUES
