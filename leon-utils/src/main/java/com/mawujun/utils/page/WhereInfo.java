...
//	}
	...
	private String op;  //operation具体的操作，例如=，>,like等
	private Object value;//具体的值，可能是字符串，也可能是字符串数组
	
	private boolean not;
	private boolean ignoreCase;
	
	private MatchMode matchModel=MatchMode.ANYWHERE; 
...
//	}
	...
	public WhereInfo(String property, String operation, Object value) {
		super();
		this.prop=property;
		this.op = operation;
		if(this.op==null){
...
//		// 创建searchFilter
//		WhereInfo filter = new WhereInfo(result[0].toString(), result[1], result[2]);
//		
//		filter.setDefaultValue(value);
//		filter.setKey(key);
//		return filter;
...
//	}
	...
	public void setMatchModel(MatchMode matchModel) {
