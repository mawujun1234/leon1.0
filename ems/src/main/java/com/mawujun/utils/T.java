...
public static final class ems_customer_contact {
...
public static final class ems_supplier {
	public static final String id="id";
	public static final String name="name";
...
public static final class ems_supplier_contact {
	public static final String contact="contact";
	public static final String phone="phone";
	public static final String mobile="mobile";
	public static final String position="position";
...
public static final class ems_workunit {
	public static final String name="name";
	public static final String memo="memo";
	public static final String status="status";
...
public static final class ems_task {
	public static final String id="id";
	public static final String memo="memo";
	public static final String type="type";
...
public static final class report_sparepartdayreport {
	public static final String daykey="daykey";
	public static final String subtype_id="subtype_id";
	public static final String subtype_name="subtype_name";
	public static final String prod_id="prod_id";
...
public static final class report_sparepartmonthreport {
	public static final String monthkey="monthkey";
	public static final String subtype_id="subtype_id";
	public static final String subtype_name="subtype_name";
	public static final String prod_id="prod_id";
...
public static final class ems_instore {
	public static final String id="id";
	public static final String store_id="store_id";
	public static final String operater="operater";
	public static final String operateDate="operateDate";
...
public static final class sys_user {
