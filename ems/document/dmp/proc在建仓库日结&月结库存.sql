create or replace procedure proc_monthinventory1_all(month_in in varchar2,lastmonth_in in varchar2)
as
begin
  for store in (
...
create or replace procedure proc_monthinventory1(store_id_in in varchar2, month_in in varchar2,lastmonth_in in varchar2)
as
...
------------------------------------------------------
create or replace procedure proc_dayinventory1_all(day_in in varchar2,lastday_in in varchar2)
as
begin
  for store in (
    select * from ems_store where type=1 
...
create or replace procedure proc_dayinventory1(store_id_in in varchar2, day_in in varchar2,lastday_in in varchar2)
as
