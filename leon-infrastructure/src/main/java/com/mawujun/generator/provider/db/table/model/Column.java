package com.mawujun.generator.provider.db.table.model;



import java.util.List;

import com.mawujun.generator.GeneratorProperties;
import com.mawujun.generator.provider.db.table.model.ForeignKey.ReferenceKey;
import com.mawujun.generator.provider.db.table.model.util.ColumnHelper;
import com.mawujun.generator.util.ExtjsDataTypesUtils;
import com.mawujun.generator.util.GLogger;
import com.mawujun.generator.util.StringHelper;
import com.mawujun.generator.util.TestDataGenerator;
import com.mawujun.generator.util.typemapping.ActionScriptDataTypesUtils;
import com.mawujun.generator.util.typemapping.DatabaseDataTypesUtils;
import com.mawujun.generator.util.typemapping.JavaPrimitiveTypeMapping;
...
//			_table.getExportedKeys().addForeignKey(refTable.getSqlName(), hasMany.columnSqlName, getSqlName(), hasMany.columnSqlName.toLowerCase().hashCode());
	...
	private void initOtherProperties() {
		...
		extjsType=ExtjsDataTypesUtils.getPreferredAsType(getJavaType());
...
//	private String rapidValidation;
	...
	public void setExtjsType(String extjsType) {
